...
\DoxyCodeLine{205       \textcolor{keywordflow}{throw} std::runtime\_error(\textcolor{stringliteral}{"{}PolyBase, tried to cast '"{}} + std::string(\mbox{\hyperlink{structtesseract__common_1_1TypeErasureBase_ac3714363cd2bfc7bb38f0f64f980b28f}{getType}}().name()) + \textcolor{stringliteral}{"{}' to '"{}} +}
...
\DoxyCodeLine{216       \textcolor{keywordflow}{throw} std::runtime\_error(\textcolor{stringliteral}{"{}PolyBase, tried to cast '"{}} + std::string(\mbox{\hyperlink{structtesseract__common_1_1TypeErasureBase_ac3714363cd2bfc7bb38f0f64f980b28f}{getType}}().name()) + \textcolor{stringliteral}{"{}' to '"{}} +}
