...
\DoxyCodeLine{79                                                 \textcolor{keyword}{const} Eigen::Vector3d\& scale,}
\DoxyCodeLine{80                                                 \mbox{\hyperlink{classtesseract__common_1_1Resource_acdba916fa227bef4391c469581844dc6}{tesseract\_common::Resource::Ptr}} resource,}
...
\DoxyCodeLine{84 \{}
\DoxyCodeLine{85   std::vector<std::shared\_ptr<T>> meshes;}
\DoxyCodeLine{86 }
\DoxyCodeLine{87   aiMatrix4x4 transform = parent\_transform;}
\DoxyCodeLine{88   transform *= node-\/>mTransformation;}
\DoxyCodeLine{89   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} j = 0; j < node-\/>mNumMeshes; ++j)}
\DoxyCodeLine{90   \{}
...
\DoxyCodeLine{95     \mbox{\hyperlink{classtesseract__geometry_1_1MeshMaterial_ad67358c38f5044f5759070974ec73e54}{MeshMaterial::Ptr}} material = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{96     std::shared\_ptr<std::vector<MeshTexture::Ptr>> textures = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{97 }
\DoxyCodeLine{98     \textcolor{keyword}{const} aiMesh* a = scene-\/>mMeshes[node-\/>mMeshes[j]];}
\DoxyCodeLine{99     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} i = 0; i < a-\/>mNumVertices; ++i)}
\DoxyCodeLine{100     \{}
\DoxyCodeLine{101       aiVector3D v = transform * a-\/>mVertices[i];}
\DoxyCodeLine{102       vertices-\/>push\_back(Eigen::Vector3d(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{double}\textcolor{keyword}{>}(v.x) * scale(0),}
\DoxyCodeLine{103                                           \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{double}\textcolor{keyword}{>}(v.y) * scale(1),}
\DoxyCodeLine{104                                           \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{double}\textcolor{keyword}{>}(v.z) * scale(2)));}
\DoxyCodeLine{105     \}}
\DoxyCodeLine{106 }
...
\DoxyCodeLine{120       \{}
\DoxyCodeLine{121         CONSOLE\_BRIDGE\_logDebug(\textcolor{stringliteral}{"{}Mesh had a face with less than three vertices: \%s"{}}, resource-\/>getUrl().c\_str());}
\DoxyCodeLine{122       \}}
\DoxyCodeLine{123     \}}
\DoxyCodeLine{124 }
...
\DoxyCodeLine{133       \{}
\DoxyCodeLine{134         aiVector3D v = transform * a-\/>mNormals[i];}
\DoxyCodeLine{135         vertex\_normals-\/>push\_back(Eigen::Vector3d(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{double}\textcolor{keyword}{>}(v.x) * scale(0),}
\DoxyCodeLine{136                                                   \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{double}\textcolor{keyword}{>}(v.y) * scale(1),}
\DoxyCodeLine{137                                                   \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{double}\textcolor{keyword}{>}(v.z) * scale(2)));}
\DoxyCodeLine{138       \}}
\DoxyCodeLine{139     \}}
\DoxyCodeLine{140 }
...
\DoxyCodeLine{145       \{}
\DoxyCodeLine{146         aiColor4D v = a-\/>mColors[0][i];}
\DoxyCodeLine{147         vertex\_colors-\/>push\_back(Eigen::Vector4d(}
\DoxyCodeLine{148             \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{double}\textcolor{keyword}{>}(v.r), \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{double}\textcolor{keyword}{>}(v.g), \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{double}\textcolor{keyword}{>}(v.b), \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{double}\textcolor{keyword}{>}(v.a)));}
\DoxyCodeLine{149       \}}
\DoxyCodeLine{150     \}}
\DoxyCodeLine{151 }
...
\DoxyCodeLine{199         \}}
\DoxyCodeLine{200 }
\DoxyCodeLine{201         material = std::make\_shared<MeshMaterial>(base\_color, metallic, roughness, emissive);}
\DoxyCodeLine{202 }
...
\DoxyCodeLine{236               \{}
\DoxyCodeLine{237                 \textcolor{keywordflow}{if} (!resource)}
\DoxyCodeLine{238                 \{}
\DoxyCodeLine{239                   \textcolor{keywordflow}{continue};}
\DoxyCodeLine{240                 \}}
\DoxyCodeLine{241                 std::string texName\_str(texName.C\_Str());}
\DoxyCodeLine{242                 \textcolor{keyword}{auto} tex\_resource = resource-\/>locateResource(texName\_str);}
...
\DoxyCodeLine{250               \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} j = 0; j < a-\/>mNumVertices; ++j)}
\DoxyCodeLine{251               \{}
\DoxyCodeLine{252                 aiVector3D v = tex\_coords[j];}
\DoxyCodeLine{253                 uvs.push\_back(Eigen::Vector2d(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{double}\textcolor{keyword}{>}(v.x), \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{double}\textcolor{keyword}{>}(v.y)));}
\DoxyCodeLine{254               \}}
...
\DoxyCodeLine{266     \}}
\DoxyCodeLine{267 }
\DoxyCodeLine{268     meshes.push\_back(std::make\_shared<T>(vertices,}
...
\DoxyCodeLine{271                                          resource,}
\DoxyCodeLine{272                                          scale,}
\DoxyCodeLine{273                                          vertex\_normals,}
\DoxyCodeLine{274                                          vertex\_colors,}
\DoxyCodeLine{275                                          material,}
...
\DoxyCodeLine{282         scene, node-\/>mChildren[n], transform, scale, resource, normals, vertex\_colors, material\_and\_texture);}
\DoxyCodeLine{283     meshes.insert(meshes.end(), child\_meshes.begin(), child\_meshes.end());}
\DoxyCodeLine{284   \}}
\DoxyCodeLine{285   \textcolor{keywordflow}{return} meshes;}
\DoxyCodeLine{286 \}}
\DoxyCodeLine{287 }
...
\DoxyCodeLine{300                                                     \textcolor{keyword}{const} Eigen::Vector3d\& scale,}
\DoxyCodeLine{301                                                     \mbox{\hyperlink{classtesseract__common_1_1Resource_acdba916fa227bef4391c469581844dc6}{tesseract\_common::Resource::Ptr}} resource,}
...
\DoxyCodeLine{307   \{}
\DoxyCodeLine{308     CONSOLE\_BRIDGE\_logWarn(\textcolor{stringliteral}{"{}Assimp reports scene in \%s has no meshes"{}}, resource-\/>getUrl().c\_str());}
\DoxyCodeLine{309     \textcolor{keywordflow}{return} std::vector<std::shared\_ptr<T>>();}
\DoxyCodeLine{310   \}}
\DoxyCodeLine{311   std::vector<std::shared\_ptr<T>> meshes = extractMeshData<T>(}
\DoxyCodeLine{312       scene, scene-\/>mRootNode, aiMatrix4x4(), scale, resource, normals, vertex\_colors, material\_and\_texture);}
\DoxyCodeLine{313   \textcolor{keywordflow}{if} (meshes.empty())}
\DoxyCodeLine{314   \{}
\DoxyCodeLine{315     CONSOLE\_BRIDGE\_logWarn(\textcolor{stringliteral}{"{}There are no meshes in the scene \%s"{}}, resource-\/>getUrl().c\_str());}
\DoxyCodeLine{316     \textcolor{keywordflow}{return} std::vector<std::shared\_ptr<T>>();}
\DoxyCodeLine{317   \}}
\DoxyCodeLine{318 }
\DoxyCodeLine{319   \textcolor{keywordflow}{return} meshes;}
\DoxyCodeLine{320 \}}
\DoxyCodeLine{321 }
...
\DoxyCodeLine{337                                                    Eigen::Vector3d scale = Eigen::Vector3d(1, 1, 1),}
...
\DoxyCodeLine{369     scene = importer.ReadFile(path.c\_str(),}
...
\DoxyCodeLine{373     scene = importer.ReadFile(path.c\_str(),}
...
\DoxyCodeLine{377   \{}
\DoxyCodeLine{378     CONSOLE\_BRIDGE\_logError(\textcolor{stringliteral}{"{}Could not load mesh from \(\backslash\)"{}\%s\(\backslash\)"{}: \%s"{}}, path.c\_str(), importer.GetErrorString());}
...
\DoxyCodeLine{399   \}}
\DoxyCodeLine{400 }
\DoxyCodeLine{401   \textcolor{keywordflow}{return} createMeshFromAsset<T>(scene, scale, \textcolor{keyword}{nullptr}, normals, vertex\_colors, material\_and\_texture);}
\DoxyCodeLine{402 \}}
\DoxyCodeLine{403 }
\DoxyCodeLine{417 \textcolor{keyword}{template} <\textcolor{keyword}{class} T>}
\DoxyCodeLine{418 std::vector<std::shared\_ptr<T>> \mbox{\hyperlink{namespacetesseract__geometry_ac1c4aaf2f6dc8a3872ea2af8b905948c}{createMeshFromResource}}(\mbox{\hyperlink{classtesseract__common_1_1Resource_acdba916fa227bef4391c469581844dc6}{tesseract\_common::Resource::Ptr}} resource,}
\DoxyCodeLine{419                                                        Eigen::Vector3d scale = Eigen::Vector3d(1, 1, 1),}
...
\DoxyCodeLine{425 \{}
\DoxyCodeLine{426   \textcolor{keywordflow}{if} (!resource)}
...
\DoxyCodeLine{431 }
\DoxyCodeLine{432   std::string resource\_url = resource-\/>getUrl();}
...
\DoxyCodeLine{442   \}}
\DoxyCodeLine{443 }
\DoxyCodeLine{444   std::vector<uint8\_t> data = resource-\/>getResourceContents();}
\DoxyCodeLine{445   \textcolor{keywordflow}{if} (data.empty())}
\DoxyCodeLine{446   \{}
\DoxyCodeLine{447     \textcolor{keywordflow}{if} (resource-\/>isFile())}
\DoxyCodeLine{448       \textcolor{keywordflow}{return} createMeshFromPath<T>(}
\DoxyCodeLine{449           resource-\/>getFilePath(), scale, triangulate, flatten, normals, vertex\_colors, material\_and\_texture);}
\DoxyCodeLine{450 }
...
\DoxyCodeLine{479     scene = importer.ReadFileFromMemory(data.data(),}
\DoxyCodeLine{480                                         data.size(),}
...
\DoxyCodeLine{486         importer.ReadFileFromMemory(data.data(),}
\DoxyCodeLine{487                                     data.size(),}
...
\DoxyCodeLine{494         \textcolor{stringliteral}{"{}Could not load mesh from \(\backslash\)"{}\%s\(\backslash\)"{}: \%s"{}}, resource-\/>getUrl().c\_str(), importer.GetErrorString());}
...
\DoxyCodeLine{514   \}}
\DoxyCodeLine{515 }
\DoxyCodeLine{516   \textcolor{keywordflow}{return} createMeshFromAsset<T>(scene, scale, resource, normals, vertex\_colors, material\_and\_texture);}
\DoxyCodeLine{517 \}}
\DoxyCodeLine{518 }
...
\DoxyCodeLine{538                                                            Eigen::Vector3d scale = Eigen::Vector3d(1, 1, 1),}
...
\DoxyCodeLine{544 \{}
\DoxyCodeLine{545   std::shared\_ptr<tesseract\_common::Resource> resource =}
...
\DoxyCodeLine{548       resource, scale, triangulate, flatten, normals, vertex\_colors, material\_and\_texture);}
\DoxyCodeLine{549 \}}
\DoxyCodeLine{550 }
\DoxyCodeLine{551 \}  \textcolor{comment}{// namespace tesseract\_geometry}}
\DoxyCodeLine{552 }
\DoxyCodeLine{553 \textcolor{preprocessor}{\#ifdef SWIG}}
\DoxyCodeLine{554 \%pybuffer\_binary(\textcolor{keyword}{const} uint8\_t* bytes, \textcolor{keywordtype}{size\_t} bytes\_len);}
\DoxyCodeLine{555 \%\textcolor{keyword}{template}(\mbox{\hyperlink{namespacetesseract__geometry_ac1c4aaf2f6dc8a3872ea2af8b905948c}{createMeshFromResource}}) tesseract\_geometry::createMeshFromResource<tesseract\_geometry::Mesh>;}
\DoxyCodeLine{556 \%\textcolor{keyword}{template}(createSDFMeshFromResource) tesseract\_geometry::createMeshFromResource<tesseract\_geometry::SDFMesh>;}
\DoxyCodeLine{557 \%\textcolor{keyword}{template}(createConvexMeshFromResource) tesseract\_geometry::createMeshFromResource<tesseract\_geometry::ConvexMesh>;}
\DoxyCodeLine{558 \%\textcolor{keyword}{template}(\mbox{\hyperlink{namespacetesseract__geometry_a1b4cdf1aee6142e3870f87d2d9a9c931}{createMeshFromPath}}) tesseract\_geometry::createMeshFromPath<tesseract\_geometry::Mesh>;}
\DoxyCodeLine{559 \%\textcolor{keyword}{template}(createSDFMeshFromPath) tesseract\_geometry::createMeshFromPath<tesseract\_geometry::SDFMesh>;}
\DoxyCodeLine{560 \%\textcolor{keyword}{template}(createConvexMeshFromPath) tesseract\_geometry::createMeshFromPath<tesseract\_geometry::ConvexMesh>;}
\DoxyCodeLine{561 \%\textcolor{keyword}{template}(\mbox{\hyperlink{namespacetesseract__geometry_a776ece4c5a30cc153042c0f13976f4f8}{createMeshFromBytes}}) tesseract\_geometry::createMeshFromBytes<tesseract\_geometry::Mesh>;}
\DoxyCodeLine{562 \%\textcolor{keyword}{template}(createSDFMeshFromBytes) tesseract\_geometry::createMeshFromBytes<tesseract\_geometry::SDFMesh>;}
\DoxyCodeLine{563 \%\textcolor{keyword}{template}(createConvexMeshFromBytes) tesseract\_geometry::createMeshFromBytes<tesseract\_geometry::ConvexMesh>;}
