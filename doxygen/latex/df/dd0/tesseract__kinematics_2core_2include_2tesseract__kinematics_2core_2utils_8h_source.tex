...
\DoxyCodeLine{310     Eigen::SelfAdjointEigenSolver<Eigen::MatrixXd> sm(m, Eigen::DecompositionOptions::EigenvaluesOnly);}
\DoxyCodeLine{311     data.\mbox{\hyperlink{structtesseract__kinematics_1_1ManipulabilityEllipsoid_a435d10bf8202bacf9cb472b0ac2c0c36}{eigen\_values}} = sm.eigenvalues().real();}
\DoxyCodeLine{312 }
\DoxyCodeLine{313     \textcolor{comment}{// Set eigenvalues near zero to zero. This also implies zero volume}}
\DoxyCodeLine{314     \textcolor{keywordflow}{for} (Eigen::Index i = 0; i < data.\mbox{\hyperlink{structtesseract__kinematics_1_1ManipulabilityEllipsoid_a435d10bf8202bacf9cb472b0ac2c0c36}{eigen\_values}}.size(); ++i)}
\DoxyCodeLine{315     \{}
\DoxyCodeLine{316       \textcolor{keywordflow}{if} (\mbox{\hyperlink{namespacetesseract__common_ac9961ff2a5d322165a817241b7746f64}{tesseract\_common::almostEqualRelativeAndAbs}}(data.\mbox{\hyperlink{structtesseract__kinematics_1_1ManipulabilityEllipsoid_a435d10bf8202bacf9cb472b0ac2c0c36}{eigen\_values}}[i], 0))}
\DoxyCodeLine{317         data.\mbox{\hyperlink{structtesseract__kinematics_1_1ManipulabilityEllipsoid_a435d10bf8202bacf9cb472b0ac2c0c36}{eigen\_values}}[i] = +0;}
\DoxyCodeLine{318     \}}
\DoxyCodeLine{319 }
...
\DoxyCodeLine{321     \textcolor{keywordflow}{if} (\mbox{\hyperlink{namespacetesseract__common_ac9961ff2a5d322165a817241b7746f64}{tesseract\_common::almostEqualRelativeAndAbs}}(data.\mbox{\hyperlink{structtesseract__kinematics_1_1ManipulabilityEllipsoid_a435d10bf8202bacf9cb472b0ac2c0c36}{eigen\_values}}.minCoeff(), 0))}
\DoxyCodeLine{322     \{}
\DoxyCodeLine{323       data.\mbox{\hyperlink{structtesseract__kinematics_1_1ManipulabilityEllipsoid_abc54d1240b184a6dc0eaf16bf6461fbe}{measure}} = std::numeric\_limits<double>::max();}
\DoxyCodeLine{324       data.\mbox{\hyperlink{structtesseract__kinematics_1_1ManipulabilityEllipsoid_a85fa8d934966c5522aad3d405fb1296b}{condition}} = std::numeric\_limits<double>::max();}
\DoxyCodeLine{325     \}}
\DoxyCodeLine{326     \textcolor{keywordflow}{else}}
\DoxyCodeLine{327     \{}
\DoxyCodeLine{328       data.\mbox{\hyperlink{structtesseract__kinematics_1_1ManipulabilityEllipsoid_a85fa8d934966c5522aad3d405fb1296b}{condition}} = data.\mbox{\hyperlink{structtesseract__kinematics_1_1ManipulabilityEllipsoid_a435d10bf8202bacf9cb472b0ac2c0c36}{eigen\_values}}.maxCoeff() / data.\mbox{\hyperlink{structtesseract__kinematics_1_1ManipulabilityEllipsoid_a435d10bf8202bacf9cb472b0ac2c0c36}{eigen\_values}}.minCoeff();}
\DoxyCodeLine{329       data.\mbox{\hyperlink{structtesseract__kinematics_1_1ManipulabilityEllipsoid_abc54d1240b184a6dc0eaf16bf6461fbe}{measure}} = std::sqrt(data.\mbox{\hyperlink{structtesseract__kinematics_1_1ManipulabilityEllipsoid_a85fa8d934966c5522aad3d405fb1296b}{condition}});}
\DoxyCodeLine{330     \}}
\DoxyCodeLine{331 }
\DoxyCodeLine{332     data.\mbox{\hyperlink{structtesseract__kinematics_1_1ManipulabilityEllipsoid_a3fb9e5490649a2f08866ddf2135e6662}{volume}} = std::sqrt(data.\mbox{\hyperlink{structtesseract__kinematics_1_1ManipulabilityEllipsoid_a435d10bf8202bacf9cb472b0ac2c0c36}{eigen\_values}}.prod());}
\DoxyCodeLine{333 }
\DoxyCodeLine{334     \textcolor{keywordflow}{return} data;}
\DoxyCodeLine{335   \};}
\DoxyCodeLine{336 }
\DoxyCodeLine{337   Eigen::MatrixXd a = jacobian * jacobian.transpose();}
...
\DoxyCodeLine{361                                         \textcolor{keyword}{const} Eigen::MatrixX2d\& limits,}
...
\DoxyCodeLine{367   \{}
\DoxyCodeLine{368     \textcolor{keywordflow}{if} (std::isinf(limits(*current\_index, 0)))}
\DoxyCodeLine{369     \{}
...
\DoxyCodeLine{378       \textcolor{keywordflow}{while} ((val -\/= (2.0 * M\_PI)) > limits(*current\_index, 0) ||}
\DoxyCodeLine{379              \mbox{\hyperlink{namespacetesseract__common_ac9961ff2a5d322165a817241b7746f64}{tesseract\_common::almostEqualRelativeAndAbs}}(val, limits(*current\_index, 0)))}
\DoxyCodeLine{380       \{}
\DoxyCodeLine{381         \textcolor{comment}{// It not guaranteed that the provided solution is within limits so this check is needed}}
\DoxyCodeLine{382         \textcolor{keywordflow}{if} (val < limits(*current\_index, 1) ||}
\DoxyCodeLine{383             \mbox{\hyperlink{namespacetesseract__common_ac9961ff2a5d322165a817241b7746f64}{tesseract\_common::almostEqualRelativeAndAbs}}(val, limits(*current\_index, 1)))}
\DoxyCodeLine{384         \{}
\DoxyCodeLine{385           Eigen::VectorXd new\_sol = sol;}
\DoxyCodeLine{386           new\_sol[*current\_index] = val;}
\DoxyCodeLine{387 }
\DoxyCodeLine{388           \textcolor{keywordflow}{if} (\mbox{\hyperlink{namespacetesseract__common_a2357c2476cbb1427a259d1dc1b8c20b6}{tesseract\_common::satisfiesPositionLimits<double>}}(new\_sol, limits))}
\DoxyCodeLine{389           \{}
\DoxyCodeLine{390             \mbox{\hyperlink{namespacetesseract__common_a1f8d20fecfeb1e99cc55d316977c3f3d}{tesseract\_common::enforcePositionLimits<double>}}(new\_sol, limits);}
\DoxyCodeLine{391             redundant\_sols.push\_back(new\_sol.template cast<FloatType>());}
\DoxyCodeLine{392           \}}
\DoxyCodeLine{393 }
\DoxyCodeLine{394           getRedundantSolutionsHelper<FloatType>(redundant\_sols, new\_sol, limits, current\_index + 1, end\_index);}
\DoxyCodeLine{395         \}}
\DoxyCodeLine{396       \}}
\DoxyCodeLine{397     \}}
\DoxyCodeLine{398 }
\DoxyCodeLine{399     \textcolor{keywordflow}{if} (std::isinf(limits(*current\_index, 1)))}
\DoxyCodeLine{400     \{}
...
\DoxyCodeLine{409       \textcolor{keywordflow}{while} ((val += (2.0 * M\_PI)) < limits(*current\_index, 1) ||}
\DoxyCodeLine{410              \mbox{\hyperlink{namespacetesseract__common_ac9961ff2a5d322165a817241b7746f64}{tesseract\_common::almostEqualRelativeAndAbs}}(val, limits(*current\_index, 1)))}
\DoxyCodeLine{411       \{}
\DoxyCodeLine{412         \textcolor{comment}{// It not guaranteed that the provided solution is within limits so this check is needed}}
\DoxyCodeLine{413         \textcolor{keywordflow}{if} (val > limits(*current\_index, 0) ||}
\DoxyCodeLine{414             \mbox{\hyperlink{namespacetesseract__common_ac9961ff2a5d322165a817241b7746f64}{tesseract\_common::almostEqualRelativeAndAbs}}(val, limits(*current\_index, 0)))}
\DoxyCodeLine{415         \{}
\DoxyCodeLine{416           Eigen::VectorXd new\_sol = sol;}
\DoxyCodeLine{417           new\_sol[*current\_index] = val;}
\DoxyCodeLine{418 }
\DoxyCodeLine{419           \textcolor{keywordflow}{if} (\mbox{\hyperlink{namespacetesseract__common_a2357c2476cbb1427a259d1dc1b8c20b6}{tesseract\_common::satisfiesPositionLimits<double>}}(new\_sol, limits))}
\DoxyCodeLine{420           \{}
\DoxyCodeLine{421             \mbox{\hyperlink{namespacetesseract__common_a1f8d20fecfeb1e99cc55d316977c3f3d}{tesseract\_common::enforcePositionLimits<double>}}(new\_sol, limits);}
\DoxyCodeLine{422             redundant\_sols.push\_back(new\_sol.template cast<FloatType>());}
\DoxyCodeLine{423           \}}
\DoxyCodeLine{424 }
\DoxyCodeLine{425           getRedundantSolutionsHelper<FloatType>(redundant\_sols, new\_sol, limits, current\_index + 1, end\_index);}
\DoxyCodeLine{426         \}}
\DoxyCodeLine{427       \}}
\DoxyCodeLine{428     \}}
\DoxyCodeLine{429   \}}
...
\DoxyCodeLine{441                                                              \textcolor{keyword}{const} Eigen::MatrixX2d\& limits,}
...
\DoxyCodeLine{478 \{}
\DoxyCodeLine{479   \textcolor{keywordflow}{for} (\textcolor{keyword}{const} \textcolor{keyword}{auto}\& q : qs)}
\DoxyCodeLine{480     \textcolor{keywordflow}{if} (!std::isfinite(q))}
...
\DoxyCodeLine{492 \mbox{\hyperlink{macros_8h_af67a6ff1a54b41b2a6e4bd36bc47b118}{DEPRECATED}}(\textcolor{stringliteral}{"{}Use redundancy version"{}})}
\DoxyCodeLine{493 inline \textcolor{keywordtype}{void} \mbox{\hyperlink{namespacetesseract__kinematics_a8269b58a5907ee0bb90b4fd3d3a937c3}{harmonizeTowardZero}}(Eigen::Ref<\mbox{\hyperlink{namespacetesseract__kinematics_a59d7ac70f855c7d00848b703e6bcfe9a}{VectorX}}<FloatType>> qs)}
\DoxyCodeLine{494 \{}
\DoxyCodeLine{495   \textcolor{keyword}{const} \textcolor{keyword}{static} \textcolor{keyword}{auto} pi = FloatType(M\_PI);}
\DoxyCodeLine{496   \textcolor{keyword}{const} \textcolor{keyword}{static} \textcolor{keyword}{auto} two\_pi = FloatType(2.0 * M\_PI);}
\DoxyCodeLine{497 }
\DoxyCodeLine{498   \textcolor{keywordflow}{for} (Eigen::Index i = 0; i < qs.rows(); ++i)}
\DoxyCodeLine{499   \{}
\DoxyCodeLine{500     FloatType diff = std::fmod(qs[i] + pi, two\_pi);}
\DoxyCodeLine{501     qs[i] = (diff < 0) ? (diff + pi) : (diff -\/ pi);}
\DoxyCodeLine{502   \}}
\DoxyCodeLine{503 \}}
\DoxyCodeLine{504 }
\DoxyCodeLine{510 \textcolor{keyword}{template} <\textcolor{keyword}{typename} FloatType>}
\DoxyCodeLine{511 \textcolor{keyword}{inline} \textcolor{keywordtype}{void} \mbox{\hyperlink{namespacetesseract__kinematics_a8269b58a5907ee0bb90b4fd3d3a937c3}{harmonizeTowardZero}}(Eigen::Ref<\mbox{\hyperlink{namespacetesseract__kinematics_a59d7ac70f855c7d00848b703e6bcfe9a}{VectorX<FloatType>}}> qs,}
\DoxyCodeLine{512                                 \textcolor{keyword}{const} std::vector<Eigen::Index>\& redundancy\_capable\_joints)}
\DoxyCodeLine{513 \{}
\DoxyCodeLine{514   \textcolor{keyword}{const} \textcolor{keyword}{static} \textcolor{keyword}{auto} pi = FloatType(M\_PI);}
\DoxyCodeLine{515   \textcolor{keyword}{const} \textcolor{keyword}{static} \textcolor{keyword}{auto} two\_pi = FloatType(2.0 * M\_PI);}
\DoxyCodeLine{516 }
\DoxyCodeLine{517   \textcolor{keywordflow}{for} (\textcolor{keyword}{const} \textcolor{keyword}{auto}\& i : redundancy\_capable\_joints)}
\DoxyCodeLine{518   \{}
\DoxyCodeLine{519     FloatType diff = std::fmod(qs[i] + pi, two\_pi);}
\DoxyCodeLine{520     qs[i] = (diff < 0) ? (diff + pi) : (diff -\/ pi);}
\DoxyCodeLine{521   \}}
\DoxyCodeLine{522 \}}
\DoxyCodeLine{523 }
\DoxyCodeLine{524 \}  \textcolor{comment}{// namespace tesseract\_kinematics}}
\DoxyCodeLine{525 \textcolor{preprocessor}{\#endif  }\textcolor{comment}{// TESSERACT\_KINEMATICS\_UTILS\_H}}
