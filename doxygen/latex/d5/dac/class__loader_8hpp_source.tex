...
\DoxyCodeLine{45 std::shared\_ptr<ClassBase> \mbox{\hyperlink{structtesseract__common_1_1ClassLoader_ad1933611b2e5247267c29b146fb3054e}{ClassLoader::createSharedInstance}}(\textcolor{keyword}{const} std::string\& symbol\_name,}
...
\DoxyCodeLine{70   \textcolor{keywordflow}{if} (!lib.has(symbol\_name))}
\DoxyCodeLine{71     \textcolor{keywordflow}{throw} std::runtime\_error(\textcolor{stringliteral}{"{}Failed to find symbol '"{}} + symbol\_name +}
...
\DoxyCodeLine{75   boost::shared\_ptr<ClassBase> plugin = boost::dll::import\_symbol<ClassBase>(lib, symbol\_name);}
\DoxyCodeLine{76 \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{77   boost::shared\_ptr<ClassBase> plugin = boost::dll::import<ClassBase>(lib, symbol\_name);}
\DoxyCodeLine{78 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{79   \textcolor{keywordflow}{return} std::shared\_ptr<ClassBase>(plugin.get(), [plugin](ClassBase*) \textcolor{keyword}{mutable} \{ plugin.reset(); \});}
\DoxyCodeLine{80 \}}
\DoxyCodeLine{81 }
\DoxyCodeLine{82 \textcolor{keywordtype}{bool} \mbox{\hyperlink{structtesseract__common_1_1ClassLoader_a0bc9e092d94b12566d67e5a5ee0de337}{ClassLoader::isClassAvailable}}(\textcolor{keyword}{const} std::string\& symbol\_name,}
...
\DoxyCodeLine{108   \}}
\DoxyCodeLine{109 }
\DoxyCodeLine{110   \textcolor{keywordflow}{return} lib.has(symbol\_name);}
\DoxyCodeLine{111 \}}
\DoxyCodeLine{112 }
...
\DoxyCodeLine{138     \textcolor{keywordflow}{return} std::vector<std::string>();}
\DoxyCodeLine{139   \}}
\DoxyCodeLine{140 }
...
\DoxyCodeLine{173     \textcolor{keywordflow}{return} std::vector<std::string>();}
\DoxyCodeLine{174   \}}
\DoxyCodeLine{175 }
...
\DoxyCodeLine{180   std::vector<std::string> sections = inf.sections();}
\DoxyCodeLine{181 }
...
\DoxyCodeLine{190   \};}
\DoxyCodeLine{191 }
\DoxyCodeLine{192   sections.erase(std::remove\_if(sections.begin(), sections.end(), search\_fn), sections.end());}
\DoxyCodeLine{193   \textcolor{keywordflow}{return} sections;}
\DoxyCodeLine{194 \}}
\DoxyCodeLine{195 }
